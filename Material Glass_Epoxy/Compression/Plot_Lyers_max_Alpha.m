...
xlabel('Alpha (°)') 
ylabel('SCF') 
title('SCFs versus Alpha for 4-layered composite plates Glass Epoxy TENSION')
...
xlabel('Alpha (°)') 
ylabel('SCF') 
title('SCFs versus Alpha for 4-layered composite plates Glass Epoxy Compression')
legend({'LYR 1','LYR 2','LYR 3','LYR 4'},'Location','northwest')