...
% Glass_Epoxy composite Stacking Sequence : [0°/45/-45/90°]
...
xlabel('Alpha (°)') 
ylabel('SCF') 
title('SCFs versus Alpha for 2-layered composite plates Glass Epoxy TENSILE')
...
xlabel('Alpha (°)') 
ylabel('SCF') 
title('SCFs versus Alpha for 2-layered composite plates Glass_Epoxy Compression')
legend({'LYR 1','LYR 2','LYR 3','LYR 4'},'Location','northwest')