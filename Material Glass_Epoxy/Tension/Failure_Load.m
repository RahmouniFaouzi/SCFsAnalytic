...
% ============================================
clear , clc , close
[numbers1, ~, ~] = xlsread('Material_Glass_Epoxy in Tension');
[numbers2, ~, ~] = xlsread('Failure_Glass_Epoxy_Without_Hole');

[numbers3, ~, ~] = xlsread('Glass-Epoxy in TN'); % RHT WITH HOLE
[numbers4, ~, ~] = xlsread('Gls-Epo_Rht-Spline_Failure_data_TN Without Hole');% RHT WITHOUT HOLE
