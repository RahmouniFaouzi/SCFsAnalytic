% Graphite_Epoxy composite Stacking Sequence Results : [0°/45°/-45°/90°]

clear, clc%#ok<*SAGROW> %

% Material Glass_Epoxy properties
[Prop, STRENGHT] = Materials('Glass-Epoxy');
E1 = Prop(1); E2 = Prop(2);
...
TA_GR =[0 45 -45 90]';
Tab  = table(TA_GR,a_tension ,tension_Ang, a_compresion, compresion_Ang , Failure_HR,...
              Failure_Ang_HR ,Failure_TH ,Failure_Ang_TH ,Failure_HV ,Failure_Ang_HV);
filename = 'Glass_Epoxy 0_45_-45_90 Results.xlsx';
