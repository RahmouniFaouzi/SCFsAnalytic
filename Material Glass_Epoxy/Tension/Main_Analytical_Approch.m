...
for th = 0 : 5 : 90 % Fiber Angle
    ...
    H1 =(E2/(2*Ga12)) - Nu21 ;
    H2 = E2/E1;
    Ga1 = ( sqrt(  H1 + sqrt(H1^2 - H2) )-1 ) / ( sqrt(  H1 + sqrt(H1^2 - H2) )+1 );%Gamma1
    Ga2 = ( sqrt(  H1 - sqrt(H1^2 - H2) )-1 ) / ( sqrt(  H1 - sqrt(H1^2 - H2) )+1 );%Gamma2
...
filename = 'Material_Glass_Epoxy in Tension.xlsx';
