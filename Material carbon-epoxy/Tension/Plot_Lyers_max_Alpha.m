...
% carbon-epoxy composite Stacking Sequence : [0°/90°]
...
xlabel('Alpha (°)') 
ylabel('SCF') 
title('SCFs versus Alpha for 2-layered composite plates carbon epoxy TENSION')
legend({'LYR 1','LYR 2'},'Location','northwest')
...
xlabel('Alpha (°)') 
ylabel('SCF') 
title('SCFs versus Alpha for 4-layered composite plates carbon epoxy Compression')
