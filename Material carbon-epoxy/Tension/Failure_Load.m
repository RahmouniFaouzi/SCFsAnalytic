...
% ============================================
clear , clc , close
[numbers1, strings1, raw1] = xlsread('Material_carbon_epoxy in Tension');
[numbers2, strings2, raw2] = xlsread('Failure_carbon_epoxy_Without_Hole');
...
title('Failure load for composite plates Glass_Epoxy in Tension')
legend({'HR','TH','HV', 'HR','TH','HV'},'Location','NorthEast')
