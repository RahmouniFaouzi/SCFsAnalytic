% GFRP composite Stacking Sequence Results : [0°/30/60/90°]
...
TA_GFRP =[0 30 60 90]';
Tab  = table(TA_GFRP,a_tension ,tension_Ang, a_compresion, compresion_Ang , Failure_HR,...
              Failure_Ang_HR ,Failure_TH ,Failure_Ang_TH ,Failure_HV ,Failure_Ang_HV);
filename = 'GFRP 0 30 60 90 Results.xlsx';
