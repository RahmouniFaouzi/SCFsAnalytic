...
for th = 0 : 5 : 90 % Fiber Angle
    ...
    % Minus Sign Belong to the applied stress Sx = -1; the opposiite
    % direction
...
Material_GFRP =0 : 5 : 90;
Tab  = table(Material_GFRP',a_tension ,tension_Ang, a_compresion, compresion_Ang , Failure_HR,...
              Failure_Ang_HR ,Failure_TH ,Failure_Ang_TH ,Failure_HV ,Failure_Ang_HV);
filename = 'Material_GFRP in comression.xlsx';
